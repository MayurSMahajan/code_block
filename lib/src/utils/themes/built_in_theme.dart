...
const builtInCodeBlockTheme = CodeBlockTheme(
  ...
  builtin_name: TextStyle(color: Color(0xff5c2699)),
  ...
  selector_id: TextStyle(color: Color(0xff9b703f)),
  selector_class: TextStyle(color: Color(0xff9b703f)),
